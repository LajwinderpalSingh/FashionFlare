...
namespace FashionFlare.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> ToggleEdit(string EditAction, int ProductId, string Name, decimal Price, int StockQuantity)
        {
            var products = await productrepository.FetchProducts();
            var categories = await categoryrepository.FetchCategoryDetail();
            var prod = new Models.UI.Product();
            ...
            {
                ViewData["EditId"] = Convert.ToInt32(EditAction.Split("-")[1]);  // Start editing this product
        ...
        public async Task<IActionResult> SaveProduct([Bind("Name,Price,ImageUrl, CategoryId, StockQuantity")] Models.UI.Product product, IFormFile ImageUrl, int CategoryId)
        {
